<template>
	<div>
	    <div style="text-align: center;width: 100%;position: relative;line-height: 40px;color:#2c2c2c">
			<router-link to="/myDollar?tabIndex=0"><img src="../assets/back.png" style="position: absolute;height: 16px;left:10px;top:12px;"></router-link>
			提现兑换说明
		</div>
		<img src="../../static/rule.png" style="width: 100%;display: block;">
	</div>
</template>
